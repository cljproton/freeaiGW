...
export const en = {
  ...
  auth: {
    ...
    err_reg_limit: "Each IP can register up to 3 accounts",
    err_username_charset: "Username must be 3-20 letters, digits or underscores",
    err_username_exists: "Username already taken",
    err_login_failed: "Incorrect username or password, or too many attempts — try again later",
    err_login_locked: "Too many attempts — please retry in {s} seconds",
  ...
  dashboard: {
    ...
    pool_title: "Available Models",
    pool_hint: "channel count & models",
    pool_channels: "channels",
    pool_empty: "No models yet — waiting for contributors…",
    pw_title: "Account Security",
    pw_sub: "Change password · other devices are signed out",
    pw_current: "Current password",
    pw_new: "New password",
    pw_confirm: "Confirm new password",
    pw_btn: "Update password",
    pw_ok: "Password updated · sessions on other devices are now invalid",
    pw_mismatch: "The two new passwords do not match",
    pw_bad_current: "Current password is incorrect",
    pw_same: "New password must differ from the current one",
    pw_note: "After a password change, sessions on other devices expire automatically while this device stays signed in.",
  },
  submit: {
    ...
    mp_search_ph: "Search models…",
    mp_count: "Selected {n} / {m} total",
    mp_select_all: "Select all",
    mp_clear: "Clear",
    mp_all_wildcard: "Support all (*)",
  ...
  errors: {
    ...
    upstream_failed: "Upstream request failed, please retry later",
    internal: "Internal server error",
    rate_limited: "Too many invalid token attempts, please retry later",
    v_username: "Username must be 3-20 letters, digits or underscores",
    v_password_short: "Password must be at least 8 characters",
    v_password_long: "Password is too long",
...
export const zh: typeof en = {
  ...
  auth: {
    ...
    err_reg_limit: "每个 IP 最多可注册 3 个账号",
    err_username_charset: "用户名需为 3-20 位字母、数字或下划线",
    err_username_exists: "用户名已存在",
    err_login_failed: "用户名或密码错误，或尝试次数过多，请稍后再试",
    err_login_locked: "尝试次数过多，请在 {s} 秒后重试",
  ...
  dashboard: {
    ...
    pool_hint: "渠道数与模型",
    pool_channels: "个渠道",
    pool_empty: "暂无可用模型，等待贡献者提交渠道…",
    pw_title: "账号安全",
    pw_sub: "修改密码 · 其他设备将被登出",
    pw_current: "当前密码",
    pw_new: "新密码",
    pw_confirm: "确认新密码",
    pw_btn: "更新密码",
    pw_ok: "密码已更新，其他设备的会话已失效",
    pw_mismatch: "两次输入的新密码不一致",
    pw_bad_current: "当前密码错误",
    pw_same: "新密码不能与当前密码相同",
    pw_note: "修改密码后，其他设备将自动退出登录，当前设备保持在线。",
  },
  submit: {
    title: "提交渠道",
  ...
  errors: {
    ...
    upstream_failed: "上游请求失败，请稍后重试",
    internal: "服务器内部错误",
    rate_limited: "无效 Token 尝试过多，请稍后再试",
    v_username: "用户名需为 3-20 位字母、数字或下划线",
    v_password_short: "密码至少 8 位",
    v_password_long: "密码过长",
